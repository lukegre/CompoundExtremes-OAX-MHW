...
![](figures/figure6-with_annotations.png)
...
2. Perpare data with Python scripts (#0-5)
3. Plot figures using `marimo` with script #6 - it's an alternative to Jupyter Notebooks
```bash
# compute extremes 
